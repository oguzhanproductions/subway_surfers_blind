...
SPEED_PROFILES: dict[str, SpeedProfile] = {_sx(199): SpeedProfile(base_speed=17.0, max_speed=30.5, cap_seconds=180.0, spawn_gap_start=1.45, spawn_gap_end=0.86), _sx(200): SpeedProfile(base_speed=18.4, max_speed=33.9, cap_seconds=180.0, spawn_gap_start=1.28, spawn_gap_end=0.74), _sx(201): SpeedProfile(base_speed=20.0, max_speed=36.0, cap_seconds=180.0, spawn_gap_start=1.12, spawn_gap_end=0.66)}

def speed_profile_for_difficulty(difficulty: str) -> SpeedProfile:
    return SPEED_PROFILES.get(difficulty, SPEED_PROFILES[_sx(200)])
