...
CHARACTERS: tuple[CharacterDefinition, ...] = (
    ...
    CharacterDefinition(
        ...
        name="Lucy",
        unlock_cost=8400,
        upgrade_costs=(1850, 3650, 6800),
        perk_kind="coin_bank_pct",
        description="Improves end-of-run coin banking with precision thief timing.",
        perk_values=(0.0, 0.07, 0.14, 0.21),
    ),
    CharacterDefinition(
        key="prince_k",
        name="Prince K",
        unlock_cost=9800,
        upgrade_costs=(2000, 3900, 7400),
        perk_kind="starting_multiplier",
        description="Starts runs with a royal score multiplier lead.",
        perk_values=(0.0, 1.0, 2.0, 3.0),
    ),
    CharacterDefinition(
        key="brody",
        name="Brody",
        unlock_cost=9000,
        upgrade_costs=(1900, 3800, 7100),
        perk_kind="power_duration_pct",
        description="Extends active power-up uptime with surfer-level focus.",
        perk_values=(0.0, 0.09, 0.18, 0.27),
    ),
    CharacterDefinition(
        key="tasha",
        name="Tasha",
        unlock_cost=9200,
        upgrade_costs=(1950, 3850, 7200),
        perk_kind="hoverboard_duration_sec",
        description="Keeps hoverboard shields active longer in clutch sections.",
        perk_values=(0.0, 2.5, 5.0, 7.5),
    ),
    CharacterDefinition(
        key="ella",
        name="Ella",
        unlock_cost=9400,
        upgrade_costs=(1950, 3900, 7300),
        perk_kind="power_duration_pct",
        description="Stretches temporary power-up windows for longer control.",
    ...
    CharacterDefinition(
        ...
        name="Ninja",
        unlock_cost=9600,
        upgrade_costs=(2000, 4000, 7600),
        perk_kind="starting_multiplier",
        description="Opens each run with a stealth multiplier advantage.",
        perk_values=(0.0, 1.0, 2.0, 3.0),
    ),
    CharacterDefinition(
        key="boombot",
